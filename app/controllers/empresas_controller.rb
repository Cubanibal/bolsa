class EmpresasController < ApplicationController
  ...
  before_action :usuario_correcto, only: %i[ edit update destroy ]
  ...
  def usuario_correcto
    @simbolo = current_usuario.empresas.find_by(id: params[:id])
    redirect_to empresas_path, notice: "No está autorizado a editar esta empresa" if @simbolo.nil?
  end
  ...
  private
    ...
    def empresa_params
      params.require(:empresa).permit(:simbolo, :usuario_id)
    end
end
