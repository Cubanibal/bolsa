...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { simbolo: @empresa.simbolo, usuario_id: @empresa.usuario_id } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { simbolo: @empresa.simbolo, usuario_id: @empresa.usuario_id } }
